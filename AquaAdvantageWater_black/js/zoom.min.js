...
(function(e){
    function u(u){
        ...
        if(!r){r=true;t.show();e("body").addClass("zoomed")}
        n.html(l).delay(500).addClass("loading");
        l.load(c).attr("src",f);i=a
    }
    function a(){
        var t=i.parent(".swiper-slide").prev();
        if(t.length==0)t=e(".swiper-wrapper .swiper-slide:last-child");
        t.find("a").trigger("click")
    }
    function f(){
        var t=i.parent(".swiper-slide").next();
        if(t.length==0)t=e(".swiper-wrapper .swiper-slide:first-child");
    ...
    (function(){
        ...
        if(e(".swiper-wrapper .swiper-slide a").length==1)e(".swiper-wrapper .swiper-slide a")[0].addClass("zoom");
        e(".zoom, .swiper-wrapper .swiper-slide a").on("click",u)})();
        (function(){
        ...
        (function(){
            e(window).on("mousewheel DOMMouseScroll",function(e){
                if(!i)return;
                e.stopPropagation();
                e.preventDefault();e.cancelBubble=false}
                )})()
})(jQuery);
