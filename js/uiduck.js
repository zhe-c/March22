...
uiduck = {
        ...
        if (e.topBar == undefined && uiduckJL != undefined) {
            for (var i = 0; i < uiduckJL.length; i++) {
                ...
                if (e.index) {
                    ...
                    // change this to make No start at 0
                    h += "<td class=" + e.style.tdClass + ">" + parseInt(uiduck.pageOptions.limit * uiduck.pageOptions.index + 0 + i) + "</td>";
                    //change this to make No start at 0
                    //change this to make No start at 0
                    //change this to make No start at 0
                }
    ...
    language: function (b) {
        ...
        if (b.language.tag == 'Chinese') {
            ...
            options = { "udHome": "Home", "udTotal": "Total items:", "udList": "Items", "udPrev": "Prev", "udNext": "Next", "udLast": "Last", "udGo": "Jump to ", "udPage": "Page", "udSub": "OK", "udNodata": "Sorry no data" };
        } else if (b.language.tag == 'Japanese') {
